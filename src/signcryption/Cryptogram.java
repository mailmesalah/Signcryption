...
public class Cryptogram {
	...
	/**
	 * Add the encrypted byte-packet and the nr of bytes telling the length of
	 * the payload. The payload length is stored in the bytes [0 ..
	 * nrOfLengthBytes] of the cleartext.
	 * 
	 * @param encrypted
	 */
	...
	public Cryptogram(byte[] encrypted, SigncryptionSettings settings) {
		this.encrypted = encrypted;
		this.settings = settings;		
	}

	/**
	 * Add the cleartext String you want to encrypt. The number of bytes you
	 * want to hold the String length. Key is typically K2 in signcryption.
	 * 
	 * @param cleartext
	...
	public Cryptogram(String cleartext, byte[] key,
		...
		encrypted = aes.encryptTimePaddingMessage(cleartext);
	}
	...
	/**
	 * Returns utf8 String representation of the bytevise cleartext.
	 * 
	 * @return String
	 */
